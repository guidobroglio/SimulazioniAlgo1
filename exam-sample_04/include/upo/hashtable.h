...
/**
 * \brief Finds the percentage of elements in the hash table that collides with key
 *
 * \param ht The hash table.
 * \param key the key to be found to compute the percentage of collisions
 * \return The percentage of entries in the hash table that collides with key, -1 if table is empty or key is not present
 */
